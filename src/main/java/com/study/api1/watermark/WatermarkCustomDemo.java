...
public class WatermarkCustomDemo {
    public static void main(String[] args) throws Exception {
        ...
        // 水位线的默认周期是200ms
//        env.getConfig().setAutoWatermarkInterval(2000);// 自定义周期
        ...
        WatermarkStrategy<WaterSensor> waterSensorWatermarkStrategy = WatermarkStrategy
                // 自定义水位线生成器
//                .<WaterSensor>forGenerator(ctx->new WatermarkCustom<>(3000))
                // 自定义断点式水位线生成器
                .<WaterSensor>forGenerator(ctx->new WatermarkBreakPointCustom<>(3000))
                // 自定义时间分配器，从数据中提取
        ...
        singleOutputStreamOperator
                ...
                .process(new ProcessWindowFunction<WaterSensor, String, String, TimeWindow>() {
                    ...
                    public void process(String s, ProcessWindowFunction<WaterSensor, String, String, TimeWindow>.Context context, Iterable<WaterSensor> elements, Collector<String> out) throws Exception {
                        ...
                        out.collect("key:" + s + "  " + startTime + "  " + endTime + "  元素：" + elements);
                    }
                }).print();
        env.execute();
    }
